...
CREATE TABLE IF NOT EXISTS rubrik_nilai (
...
CREATE TABLE IF NOT EXISTS tugas_besar_kelompok (
...
CREATE TABLE IF NOT EXISTS mata_kuliah_dosen (
    id_user VARCHAR(30) NOT NULL,
    kode_mk VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS mata_kuliah_mahasiswa (
    id_user VARCHAR(30) NOT NULL,
    kode_mk VARCHAR(15) NOT NULL,
    kelas VARCHAR(3) NOT NULL,
    semester INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS user_kelompok (
    id_user VARCHAR(30) NOT NULL,
    id_kelompok INT NOT NULL,
