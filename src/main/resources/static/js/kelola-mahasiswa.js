document.addEventListener("DOMContentLoaded", () => {
    ...
    const importView = document.getElementById("import-mahasiswa");
    const manualView = document.getElementById("tambah-mahasiswa");

    const btnImport = document.getElementById("btn-import");
    const btnManual = document.getElementById("btn-manual");

    const tambahForm = document.getElementById("tambah-mahasiswa-form");
    ...
    /* ============================================================
       VIEW: HAPUS MAHASISWA
    ============================================================ */
    const hapusView = document.getElementById("view-hapus-mahasiswa"); 
    ...
    btnAdd.addEventListener("click", () => {
        ...
        subTitle.textContent = " > Tambah Mahasiswa";
        subTitle2.textContent = "";
    });
    ...
    tambahForm.addEventListener("submit", (e) => {
        ...
        let nip = document.getElementById("npm-mahasiswa").value;
        let nama = document.getElementById("nama-mahasiswa").value;
        let mk = document.getElementById("sem-mahasiswa").value;
        let status = document.getElementById("status-mahasiswa").value;
    ...
    /* ============================================================
       UPDATE LIST MAHASISWA (AUTOCOMPLETE)
    ============================================================ */
    function updateMahasiswaList() {
        ...
        rows.forEach(r => {
            ...
            if (namaCell) {
                daftarMahasiswa.push(namaCell.textContent.trim());
            }
        });
    }
    ...
    btnDelete.addEventListener("click", () => {
        ...
        subTitle.textContent = " > Hapus Mahasiswa";
    });
    ...
    searchInput.addEventListener("input", () => {
        ...
        const hasil = daftarMahasiswa.filter(n => n.toLowerCase().includes(keyword));
    ...
    btnConfirmDeleteFinal.addEventListener("click", () => {
        ...
        const rows = tableView.querySelectorAll(".data-row");
        rows.forEach(row => {
            if (row.children[2].textContent.trim() === selectedMahasiswa) {
                row.remove();
            }
        });
